...
class Properties extends AdditionalProperties
  ...
  static Properties fromJson(Map<String, dynamic>? json) {
    ...
    final page = PresentationPage.from(
    ...
    final orientation = PresentationOrientation.from(
      jsonObject.optNullableString('orientation', remove: true),
    );
    final layout = EpubLayout.from(
      jsonObject.optNullableString('layout', remove: true),
    );
    final overflow = PresentationOverflow.from(
      jsonObject.optNullableString('overflow', remove: true),
    );
    final spread = PresentationSpread.from(
...
class PropertiesJsonConverter
    extends JsonConverter<Properties?, Map<String, dynamic>?> {
