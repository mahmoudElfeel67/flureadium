...
import 'package:flureadium_platform_interface/src/utils/uri_template.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  test('parameters works fine', () {
    expect(['x', 'hello', 'y', 'z', 'w'], UriTemplate('/url{?x,hello,y}name{z,y,w}').parameters);
  });

  test('expand works fine with simple string templates', () {
    final template = UriTemplate('/url{x,hello,y}name{z,y,w}');
    final parameters = {'x': 'aaa', 'hello': 'Hello, world', 'y': 'b', 'z': '45', 'w': 'w'};
  ...
  test('expand works fine with form-style ampersand-separated templates', () {
    ...
    expect('/url?x=aaa&hello=Hello,%20world&y=bname', template.expand(parameters));
