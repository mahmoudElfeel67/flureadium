...
extension FlureadiumPlugin {
  ...
  private func loadPublication (
    ...
    do {
      let pub: (Publication, Format) = try await self.openPublication(at: absUrl, allowUserInteraction: true)
  ...
  static func renderFirstPage(pubUrlStr: String, maxWidth: Int, maxHeight: Int) -> Data? {
    ...
    // macOS: Use NSGraphicsContext instead of UIGraphicsBeginImageContext
