...
import 'localizations_repository.dart';

class ReaderSharedLocalizations implements LocalizationsRepository {
  ReaderSharedLocalizations(this.locale);
  static const SimpleLocalizationDelegate<ReaderSharedLocalizations> delegate = _ReaderSharedLocalizationsDelegate();

  final String locale;

  @override
  String getMessage(String name, List<Object>? args) =>
      Intl.message(name, name: name, args: args, locale: locale.toString());
  ...
  String get r2SharedPublicationOpeningExceptionUnsupportedFormat => Intl.message(
  ...
  String get r2SharedPublicationOpeningExceptionIncorrectCredentials => Intl.message(
  ...
  String get r2SharedResourceExceptionNotFound =>
      Intl.message('Resource not found', name: 'r2_shared_resource_exception_not_found', locale: locale.toString());
  ...
  String get r2SharedResourceExceptionOther =>
      Intl.message('A service error occurred', name: 'r2_shared_resource_exception_other', locale: locale.toString());
}

class _ReaderSharedLocalizationsDelegate extends SimpleLocalizationDelegate<ReaderSharedLocalizations> {
  ...
  @override
  Future<bool> initializeMessages(String localeName) => m.initializeMessages(localeName);
}
